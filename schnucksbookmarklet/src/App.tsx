    ...
    <div className="App">
      <header className="App-header">
        ...
        <p>
          ...
          <a target="_blank" rel="noopener noreferrer" className="App-link" href="https://nourish.schnucks.com/web-ext/coupons">Schnucks coupon page.</a>
        </p>
        <a
          className="App-link"
        ...
        <p>(P.S. you really shouldn't just run random code from the internet)</p>
      </header> 
      <div>
      <Editor
     height="90vh"
